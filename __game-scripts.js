...
Menu.prototype.initialize = function() {
    ...
    this.entity.on("destroy", this.onDestroy, this),
    "undefined" != typeof VERSION_CODE && (this.versionEntity.element.text = "" + VERSION_CODE),
...
Table.prototype._onInit = function() {
    ...
    t += ".two-buttons td:last-child, .two-buttons th:last-child { width: 10vw; }",
    ...
    for (var i in t = t.result) {
        ...
        for (var r in this.keys) {
            ...
            if (o.search("\\$verified") > -1) {
                ...
                "1" == a.verified && (l = '<img src="' + e.getFileUrl() + '" class="verification">'),
                s.innerHTML = l + " " + this.formatMarkup(a[h], h)
            } else
                "$thumbnail" == o ? this.createThumbnail(a, s) : "$button" == o || "$button" == a[o] || a[o] && a[o].length > 0 && a[o].search("\\$button") > -1 ? this.createButtons(a, o, s) : "$index" == o ? s.innerText = parseInt(i) + 1 : s.innerHTML = this.formatMarkup(a[o], o);
            n.appendChild(s)
        }
