...
var Utils = {
    ...
    closestPointLine: function (e, t, r) {
      ...
      return (
        ...
        { point: { x: t.x + o * c, y: t.y + n * c }, left: i < 1, dot: i, t: c }
      );
    },
...
Movement.attributes.add("defaultSpeed", { type: "number" }),
  ...
  Movement.attributes.add("defaultNonFov", { type: "number", default: 60 }),
  ...
  (Movement.prototype.dash = function () {
    ...
    (this.isDashing = !0),
      ...
      this.app.tween(this.animation).to({ fov: 10 }, 0.2, pc.BackOut).start(),
      this.axeEntity.setLocalEulerAngles(106.08, 39.04, 48.43),
      this.axeEntity
        .tween(this.axeEntity.getLocalEulerAngles())
        .rotate({ x: 48.79, y: -44.81, z: 34.89 }, 0.25, pc.BackOut)
        .delay(0.08)
        .start(),
      setTimeout(
        function (t) {
    ...
    this.axeEntity.setLocalPosition(-1.341, -2.65, -3.462),
      ...
      Math.random() > 0.5
        ? (this.axeEntity.setLocalEulerAngles(66.97, -17.07, 29.54),
          this.axeEntity
            .tween(this.axeEntity.getLocalEulerAngles())
            .rotate({ x: -20.32, y: 40.6, z: -108.25 }, 0.25, pc.BackOut)
            .delay(0.2)
            .start())
        : (this.axeEntity.setLocalEulerAngles(-42.45, -13.74, 21.08),
          this.axeEntity
            .tween(this.axeEntity.getLocalEulerAngles())
            .rotate({ x: 37.81, y: -38.75, z: -130.44 }, 0.25, pc.BackOut)
            .delay(0.2)
            .start()),
      setTimeout(
        function (t) {
          t.meleeTrigger(),
            ...
            t.app
              .tween(t.animation)
              .to({ cameraImpact: -3 }, 0.1, pc.BackOut)
              .start();
        },
        200,
        this
  ...
  (Movement.prototype.throwShurikenAnimation = function () {
    this.shoulderEntity
      ...
      .rotate({ x: 42.75, y: 30.65, z: -57.65 }, 0.4, pc.SineOut)
      .start(),
      this.shoulderEntity.reparent(this.handEntity),
      this.app
        .tween(this.animation)
        .to({ takeX: -0.52, takeY: 22.19, takeZ: -55.11 }, 0.1, pc.BackInOut)
        .start(),
      setTimeout(
        function (t) {
          t.shoulderEntity
            .tween(t.shoulderEntity.getLocalEulerAngles())
            .rotate({ x: 147.77, y: 3.9, z: 138.54 }, 0.1, pc.Linear)
            .start();
        },
        50,
        this
      ...
      setTimeout(
        function (t) {
          t.shoulderEntity
            .tween(t.shoulderEntity.getLocalEulerAngles())
            .rotate({ x: 113.4, y: -9.2, z: 25.38 }, 0.15, pc.QuinticInOut)
            .start(),
            setTimeout(function () {
              t.throwShuriken();
            }, 15);
      ...
      setTimeout(
        function (t) {
          t.shoulderEntity
            .tween(t.shoulderEntity.getLocalEulerAngles())
            .rotate({ x: 64.6, y: 4.31, z: 1.91 }, 0.2, pc.BackOut)
            .start();
        },
        850,
        this
      ...
      setTimeout(
        function (t) {
          (t.isThrowing = !1),
            ...
            t.shoulderEntity
              .tween(t.shoulderEntity.getLocalEulerAngles())
              .rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackOut)
              .start(),
            t.app
              .tween(t.animation)
              .to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.2, pc.BackInOut)
              .start();
        },
        1e3,
        this
  ...
  (Movement.prototype.throwGrenadeAnimation = function () {
    this.shoulderEntity
      ...
      this.app
        .tween(this.animation)
        .to({ takeX: -0.52, takeY: 22.19, takeZ: -55.11 }, 0.15, pc.BackInOut)
        .start(),
      setTimeout(
        function (t) {
          t.shoulderEntity
            .tween(t.shoulderEntity.getLocalEulerAngles())
            .rotate({ x: 147.77, y: 3.9, z: 138.54 }, 0.2, pc.Linear)
            .start();
        },
        200,
        this
      ...
      setTimeout(
        function (t) {
          t.playEffortSound(),
            t.shoulderEntity
              .tween(t.shoulderEntity.getLocalEulerAngles())
              .rotate({ x: 113.4, y: -9.2, z: 25.38 }, 0.55, pc.QuinticInOut)
              .start(),
            setTimeout(function () {
              t.throwGrenade(),
                t.app
  ...
  (Movement.prototype.slowMovement = function (t) {
    this.app
      .tween(this.animation)
      .to({ movementFactor: 0.1 }, t, pc.Linear)
      .start();
  }),
  (Movement.prototype.fastMovement = function () {
    this.app
      .tween(this.animation)
      .to({ movementFactor: 1 }, 0.4, pc.Linear)
      .start();
  }),
            ...
            (this.timer.inspect2 = setTimeout(
              function (t) {
                t.tween.inspect2 = t.app
                  .tween(t.animation)
                  .to(
                    { movementAngleX: 0, movementAngleY: 0, movementAngleZ: 0 },
                    0.5,
                    pc.BackInOut
                  )
                  .start();
  ...
  (Movement.prototype.reload = function () {
    return (
      ...
      "Shotgun" == this.currentWeapon.type
        ...
        : ((this.timerTween[2] = this.app
            .tween(this.animation)
            .to(
              { weaponAngleX: 29.25, weaponAngleY: 6.02, weaponAngleZ: 30.34 },
              0.4,
              pc.BackInOut
            )),
      ...
      this.timerBag.push(
        setTimeout(
          function (t) {
            (t.timerTween[4] = t.app
              .tween(t.animation)
              .to({ bounceAngle: -5 }, 0.1, pc.BackInOut)),
      ...
      this.timerBag.push(
        setTimeout(
          function (t) {
            (t.timerTween[6] = t.app
              .tween(t.animation)
              .to({ bounceZ: -0.1 }, 0.15, pc.BackInOut)),
      ...
      this.timerBag.push(
        setTimeout(
          function (t) {
            (t.timerTween[7] = t.app
              .tween(t.animation)
              .to(
                { weaponAngleX: 0, weaponAngleY: 0, weaponAngleZ: 0 },
                0.15,
                pc.BackInOut
              )),
  ...
  (Movement.prototype.takeout = function () {
    (this.animation.takeX = -0.52),
      ...
      this.app
        .tween(this.animation)
        .to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.3, pc.BackInOut)
        .start(),
      this.entity.sound.play("Takeout"),
  ...
  (Movement.prototype.showMelee = function () {
    (this.meleeCenter.enabled = !0),
      this.meleeCenter
        ...
        .to({ y: -0.246 }, 0.2, pc.BackOut)
        .start();
  }),
  (Movement.prototype.hideMelee = function () {
    this.meleeCenter
      .tween(this.meleeCenter.getLocalPosition())
      .to({ y: -1.5 }, 0.15, pc.BackOut)
      .start(),
      setTimeout(
        function (t) {
  ...
  (Movement.prototype.impact = function () {
    ...
    if (
      (this.app
        .tween(this.animation)
        .to({ cameraImpact: -t }, 0.09, pc.BackOut)
        .start(),
  ...
  (Movement.prototype.jump = function () {
    ...
    this.app
      .tween(this.animation)
      .to({ jumpAngle: -11 }, 0.15, pc.BackOut)
      .start();
  }),
  (Movement.prototype.bounceJump = function (t, e) {
    ...
    this.app
      .tween(this.animation)
      .to({ jumpAngle: -18, cameraShootBounce: 2, fov: 10 }, 0.15, pc.BackOut)
      .start();
  }),
    ...
    if (Math.abs(this.currentHeight - this.lastHeight) > 0.1) {
      ...
      this.entity.sound.play("Land-" + e),
        this.app
          .tween(this.animation)
          .to(
            { landAngle: -0.4 * t, cameraShootBounce: -5 * t },
            0.15,
            pc.BackOut
          )
          .start(),
    ...
    if (
      ...
      (this.lookY += 0.04 * i),
        ...
        this.app
          .tween(this.animation)
          .to(
            { bounceX: s, bounceZ: n, bounceAngle: o, shootSwing: h },
            0.03,
            pc.BackOut
          )
          .start(),
  ...
  ((function (t, e) {
    ...
    function D(t, o) {
      ...
      function V() {
        ...
        (E.length = 0),
        C))
          C[m] && h[m].heatOn && E.push({ name: m, el: C[m] });
...
Overlay.attributes.add("focusBulletsEntity", { type: "entity" }),
  ...
  (Overlay.prototype.onFollowUser = function (t) {
    this.app.fire("Fetcher:Follow", { username: t }),
  ...
  (Overlay.prototype.openReport = function () {
    this.app.fire("View:Pause", "Report"),
      this.app.fire("Table:Users", { result: this.stats }),
      this.app.fire("Table:KickUsers", { result: this.stats });
  }),
  ...
  (Overlay.prototype.onTeamChange = function (t) {
    ...
    (this.teamNotification.enabled = !0),
      ...
      this.teamNotification
        ...
        .to({ x: 0, y: 150, z: 0 }, 0.8, pc.BackOut)
        .start(),
      "red" == t
  ...
  (Overlay.prototype.setWhiteShadow = function (t) {
    t
      ...
      : this.holdAnimation &&
        ...
        (this.holdAnimation = this.holdBarEntity
          .tween(this.holdBarEntity.getLocalScale())
          .to({ x: 0.01, y: 1, z: 1 }, 0.5, pc.SineIn)),
        this.holdAnimation.start(),
      ...
      setTimeout(
        function (t) {
          t
            ...
            .to({ x: 0, y: 50, z: 0 }, 0.2, pc.BackOut)
            .start(),
            t.tween(t.element).to({ opacity: 0 }, 0.2, pc.Linear).start();
        },
        400,
        e
      ),
  ...
  (Overlay.prototype.onCards = function (t) {
    ...
    for (var o in this.cardEntities) {
      ...
      r
        ...
        .to({ x: s, y: y, z: 0 }, 0.5, pc.BackOut)
        .delay(h)
        .start(),
        r
          .tween(r.getLocalScale())
          .to({ x: 0.7, y: 0.7, z: 0.7 }, 1, pc.BackOut)
          .delay(h)
          .start(),
        setTimeout(
          function (t, e) {
            (e.key.enabled = !0),
              ...
              e.glow
                ...
                .to({ opacity: 0.1 }, 0.2, pc.Linear)
                .delay(0.3)
                .start(),
              e.glow
                .tween(e.glow.getLocalScale())
                .to({ x: 1.1, y: 1.1, z: 1.1 }, 0.2, pc.BackOut)
                .delay(0.3)
                .start(),
  ...
  (Overlay.prototype.setAbility = function (t) {
    ...
    (this.cardTimer.enabled = !1),
      ...
      e
        .tween(e.getLocalPosition())
        .to({ x: 0, y: 0, z: 0 }, 0.5, pc.BackOut)
        .start(),
      e
        .tween(e.getLocalScale())
        .to({ x: 1.1, y: 1.1, z: 1.1 }, 0.5, pc.BackOut)
        .delay(0.4)
        .start(),
      e
        .tween(e.getEulerAngles())
        .rotate({ x: 0, y: 0, z: 0 }, 0.3, pc.BackOut)
        .start(),
      setTimeout(
        function (t) {
          t.entity.sound.play("Add-Ability"),
            e
              .tween(e.getLocalPosition())
              .to({ x: 600, y: -100, z: 0 }, 0.4, pc.Linear)
              .start(),
            e
              .tween(e.getLocalScale())
              .to({ x: 0.32, y: 0.32, z: 0.32 }, 0.35, pc.Linear)
              .delay(0.05)
              .start(),
            e
              .tween(e.getLocalEulerAngles())
              .rotate({ x: 0, y: 0, z: 90 }, 0.2, pc.BackOut)
              .delay(0.2)
              .start(),
            setTimeout(function () {
              t.cardBackground
                .tween(t.cardBackground.element)
                .to({ opacity: 1, color: pc.colors.black }, 0.2, pc.Linear)
                .start();
            }, 400),
            setTimeout(function () {
    ...
    if (i > -1) {
      ...
      if (a && a.element && a.element.color) {
        ...
        a
          ...
          .to({ x: 1.2, y: 1.2, z: 1.2 }, 0.2, pc.BackOut)
          .start(),
  ...
  (Overlay.prototype.hideCircularMenu = function () {
    this.entity.sound.play("Whoosh"),
      this.circularEntity
        .tween(this.circularEntity.getLocalPosition())
        .to({ x: 0, y: -300, z: 0 }, 0.5, pc.BackOut)
        .start(),
      setTimeout(
        function (t) {
  ...
  (Overlay.prototype.onTransition = function (t) {
    t
      ...
      this.leftCinema
        ...
        .to({ x: 1.4, y: 1, z: 1 }, 0.35, pc.Linear)
        .start(),
        ...
        function (t) {
          t.leftCinema.setLocalEulerAngles(0, 0, -15),
            t.leftCinema
              ...
              .to({ x: 0.1, y: 1, z: 1 }, 0.35, pc.Linear)
              .start(),
  ...
  (Overlay.prototype.setStatus = function (t) {
    (this.statusEntity.enabled = !0),
      ...
      this.statusEntity
        ...
        .to({ x: 0, y: -85, z: 0 }, 0.2, pc.BackOut)
        .start(),
  ...
  (Overlay.prototype.setReminder = function (t) {
    ...
    (this.reminderEntity.enabled = !0),
      ...
      this.reminderEntity
        ...
        .to({ x: 0, y: 260, z: 0 }, 0.25, pc.BackOut)
        .start(),
  ...
  (Overlay.prototype._onTaskMessage = function (t, e, i, a, n) {
    (this.taskEntity.enabled = !0),
      ...
      this.taskEntity
        ...
        .to({ x: 0, y: 25, z: 0 }, 0.25, pc.BackOut)
        .start(),
      ...
      (this.taskHideTimer = setTimeout(
        function (t) {
          t.taskEntity
            ...
            .to({ x: 0, y: -75, z: 0 }, 0.1, pc.BackOut)
            .start(),
            setTimeout(function () {
  ...
  (Overlay.prototype.onUnlock = function (t, e) {
    ...
    for (var a in i) {
      ...
      n.setLocalPosition(84.136, 89.082, 0),
        ...
        n
          ...
          .to({ x: 640, y: 265 }, 1, pc.BackOut)
          .delay(s)
          .start(),
        n
          .tween(n.getLocalEulerAngles())
          .rotate({ z: 165 }, 1, pc.Linear)
          .delay(s)
          .start(),
        n
          .tween(n.element)
    ...
    (this.achievementEntity.enabled = !0),
      ...
      this.achievementEntity
        ...
        .to({ x: 0, y: 38, z: 0 }, 0.15, pc.BackOut)
        .start(),
      this.hasAbility ||
        ...
        this.abilityInfo
          ...
          .to({ x: -165, y: 0, z: 0 }, 0.3, pc.Linear)
          .yoyo(!0)
          .repeat(7)
          .start(),
        setTimeout(
  ...
  (Overlay.prototype.onDamage = function (t) {
    ...
    a > -180 && a < 0 && (this.leftDamageEntity.element.opacity = 0.8),
      ...
      this.damageIndictator
        ...
        .to({ x: 0.92, y: 0.92, z: 0.92 }, 0.18, pc.BackInOut)
        .start();
  ...
  (Overlay.prototype.onAnnounce = function (t, e, i, a) {
    (this.announceEntity.enabled = !0),
      ...
      this.announceIconEntity
        ...
        .to({ x: 1, y: 1, z: 1 }, 0.15, pc.SineOut)
        .start();
    ...
    if (
      ...
      this.announceInfoEntity
        ...
        .to({ x: 0, y: -22, z: 0 }, 0.3, pc.SineOut)
        .delay(0.5)
        .start(),
  ...
  (Overlay.prototype.onJumping = function () {
    this.crosshairEntity
      .tween(this.crosshairEntity.element)
      .to({ width: 70, height: 70 }, 0.15, pc.SineOut)
      .start();
  }),
  (Overlay.prototype.onNotification = function (t, e, i) {
    ...
    if ("message" == t)
      ((n = this.notificationMessage.clone()).findByName(
        ...
        e.split("]").length > 1
          ? (n.element.width = 7 * (e[1].length - 23))
          : (n.element.width = 7 * (e[0].length - 23));
    else if ("kill" == t && e.killer && e.killed) {
      var s = e.killer.split("]");
      s.length > 1
        ? (killerLength = 5 + s[1].length)
        : (killerLength = s[0].length);
      var o = e.killed.split("]");
      o.length > 1
        ? (killedLength = 5 + o[1].length)
        : (killedLength = o[0].length);
    ...
    (n.enabled = !0),
      ...
      n
        .tween(n.getLocalPosition())
        .to({ x: 0, y: a, z: 0 }, 0.15, pc.BackOut)
        .start(),
  ...
  (Overlay.prototype.showPrepare = function () {
    (this.prepareEntity.enabled = !0),
      ...
      this.prepareEntity
        ...
        .to({ x: 1.5, y: 1.5, z: 1.5 }, 0.1, pc.SineOut)
        .start();
  }),
...
Weapon.attributes.add("type", {
  type: "string",
  enum: [{ Rifle: "Rifle" }, { Shotgun: "Shotgun" }, { Sniper: "Sniper" }],
  default: "Rifle",
}),
  ...
  (Weapon.prototype.hideArms = function () {
    this.armEntity.setLocalPosition(this.handPoint.getLocalPosition().clone()),
      this.armEntity
        ...
        .to({ x: -0.3, y: -1.2, z: 0 }, 0.2, pc.BackInOut)
        .start();
  }),
  (Weapon.prototype.magazineThrow = function () {
    this.barrelPoint &&
      ...
      this.magazinePoint
        ...
        .to({ x: 0.5, y: -7, z: 0 }, 0.4, pc.BackInOut)
        .start(),
      this.magazinePoint
        .tween(this.magazinePoint.getLocalEulerAngles())
        .rotate({ x: 0, y: 0, z: 30 }, 0.3, pc.BackInOut)
        .start(),
  ...
  (Weapon.prototype.magazineAttach = function () {
    this.barrelPoint &&
      this.barrelPoint
        .tween(this.barrelPoint.getLocalEulerAngles())
        .rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut)
        .start(),
      this.magazinePoint
        .tween(this.magazinePoint.getLocalPosition())
        .to({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut)
    ...
    this.armEntity
      .tween(this.armEntity.getLocalPosition())
      .to({ x: t.x, y: t.y, z: t.z }, 0.2, pc.BackInOut)
      .delay(0.2)
      .start(),
...
EffectManager.attributes.add("shootRay", { type: "entity" }),
  ...
  (EffectManager.prototype.onKillSphere = function (t) {
    ...
    var i = this.killSphereEntity
      ...
      .to({ x: 15, y: 15, z: 15 }, 0.3, pc.CircularOut);
  ...
  (EffectManager.prototype.onShuriken = function (t, e, i, a, s) {
    ...
    h.setLocalPosition(t),
      ...
      h
        ...
        .to({ x: p.x, y: p.y, z: p.z }, 0.2, pc.Linear)
        .start(),
      l &&
        setTimeout(
          function (t, e, a) {
      ...
      x.setPosition(i),
        ...
        pc.controls.player.playerId == a
          ? x.trace
              ...
              .to({ x: 0, y: 0, z: -300 }, 2, pc.Linear)
              .start()
          : x.trace
              .tween(x.trace.getLocalPosition())
              .to({ x: 0, y: 0, z: -300 }, 1, pc.Linear)
              .start();
    }
    this.shootRayIndex++,
...
Sprite.attributes.add("type", {
  type: "string",
  enum: [{ blending: "blending" }, { "animated-2d": "animated-2d" }],
  default: "blending",
}),
...
Hitmarker.attributes.add("hitPointEntity", { type: "entity" }),
  ...
  (Hitmarker.prototype.onHeadshot = function (t, e) {
    ...
    r.setLocalScale(0.2, 0.2, 0.2),
      r
        .tween(r.getLocalScale())
        .to({ x: 2, y: 2, z: 2 }, 0.4, pc.SineOut)
        .start(),
      r
        .tween(r.getLocalPosition())
        .to({ x: a, y: this.distance, z: 0 }, this.duration, pc.SineOut)
        .start(),
      r
        .tween(r.element)
        .to({ opacity: 0 }, this.duration + 0.5, pc.SineOut)
        .start(),
      this.points.push(i),
      ...
      this.hitmarkerEntity
        ...
        .to({ x: 1.2, y: 1.2, z: 1.2 }, 0.25, pc.BackOut)
        .start(),
      (this.lastHeadshot = Date.now());
  }),
  (Hitmarker.prototype.onHitPoint = function (t, e) {
    ...
    var n = r
      .tween(r.element)
      .to({ opacity: 0 }, this.duration + 0.5, pc.Linear);
    n.on("update", function (t) {
      ...
      this.hitmarkerEntity
        .tween(this.hitmarkerEntity.getLocalScale())
        .to({ x: 1.2, y: 1.2, z: 1.2 }, 0.15, pc.BackOut)
        .start(),
      (this.lastHitTime = Date.now());
  }),
...
NetworkManager.attributes.add("isDebug", { type: "boolean", default: !0 }),
  ...
  (NetworkManager.prototype.damage = function (e) {
    ...
    if (t) {
      var i = t.getPosition();
      this.app.fire("Overlay:Damage", { x: i.x, y: i.y, z: i.z });
    }
  }),
...
!(function (t, r) {
  ...
  const r = ["B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"],
    e = (t, r) => {
      ...
      return (
        "string" == typeof r
          ? (e = t.toLocaleString(r))
          : !0 === r && (e = t.toLocaleString()),
        e
      );
    };
  for (
    var n = function (t) {
      ...
      i = function (t) {
        for (
          ...
          (r =
            ...
            (o[f++] = 255 & r);
        2 === i &&
          ((r = (u[t.charCodeAt(h)] << 2) | (u[t.charCodeAt(h + 1)] >> 4)),
          (o[f++] = 255 & r));
        1 === i &&
          ((r =
            (u[t.charCodeAt(h)] << 10) |
      ...
      o = function (t) {
        for (
          var r, e = t.length, n = e % 3, i = [], o = 0, u = e - n;
          o < u;
          o += 16383
        )
          i.push(p(t, o, o + 16383 > u ? u : o + 16383));
        1 === n
          ? ((r = t[e - 1]), i.push(f[r >> 2] + f[(r << 4) & 63] + "=="))
          : 2 === n &&
            ((r = (t[e - 2] << 8) + t[e - 1]),
  ...
  var y,
    g = { byteLength: n, toByteArray: i, fromByteArray: o },
    d = {
          ...
          r = Math.abs(r),
            isNaN(r) || r === 1 / 0
              ...
              : ((f = Math.floor(Math.log(r) / Math.LN2)),
                ...
                (r += f + c >= 1 ? l / a : l * Math.pow(2, 1 - c)) * a >= 2 &&
                  (f++, (a /= 2)),
                f + c >= h
                  ? ((u = 0), (f = h))
                  : f + c >= 1
                  ? ((u = (r * a - 1) * Math.pow(2, i)), (f += c))
    ...
    w =
      ((function (t, r) {
        ...
        function a(t) {
          for (
            var r = t.length < 0 ? 0 : 0 | s(t.length), e = n(r), i = 0;
            i < r;
            i += 1
          )
            e[i] = 255 & t[i];
        ...
        (r.kMaxLength = e),
          ...
          (i.concat = function (t, r) {
            ...
            for (e = 0; e < t.length; ++e) {
              var f = t[e];
              if ((j(f, Uint8Array) && (f = i.from(f)), !i.isBuffer(f)))
                throw new TypeError(
                  '"list" argument must be an Array of Buffers'
                );
        ...
        (i.prototype.slice = function (t, r) {
          ...
          (i.prototype.readFloatLE = function (t, r) {
            return (
              (t >>>= 0), r || T(t, 4, this.length), d.read(this, t, !0, 23, 4)
            );
          }),
          (i.prototype.readFloatBE = function (t, r) {
            return (
              (t >>>= 0), r || T(t, 4, this.length), d.read(this, t, !1, 23, 4)
            );
          }),
          (i.prototype.readDoubleLE = function (t, r) {
            return (
              (t >>>= 0), r || T(t, 8, this.length), d.read(this, t, !0, 52, 8)
            );
          }),
          (i.prototype.readDoubleBE = function (t, r) {
            return (
              (t >>>= 0), r || T(t, 8, this.length), d.read(this, t, !1, 52, 8)
            );
          }),
  ...
  var v = {
      initialize: (t, n) => {
        if ("number" != typeof t || !0 === Number.isNaN(t))
          throw Error(
            '@initialize : expecting "tempBufferLength" to be a number.'
          );
        if (t < 1)
          throw Error(
            '@initialize : expecting "tempBufferLength" to be greater than zero.'
          );
        if (void 0 !== n) {
          if ("function" != typeof n)
            throw Error(
              '@initialize : expecting "logFunction" to be a function.'
            );
          n(
            `@initialize : setting buffer limit to ${((t, n) => {
              if (!Number.isFinite(t))
                throw new TypeError(
                  `Expected a finite number, got ${typeof t}: ${t}`
                );
              if ((n = Object.assign({}, n)).signed && 0 === t) return " 0 B";
              const i = t < 0,
                o = i ? "-" : n.signed ? "+" : "";
              if ((i && (t = -t), t < 1)) return o + e(t, n.locale) + " B";
              const f = Math.min(Math.floor(Math.log10(t) / 3), r.length - 1);
              return (
                (t = Number((t / Math.pow(1e3, f)).toPrecision(3))),
                o + e(t, n.locale) + " " + r[f]
              );
            })(t)}`
          );
        ...
        const s = (t) => {
          ...
          switch (typeof t) {
            ...
            case "object":
              ...
              if (
                (t instanceof ArrayBuffer && (t = b.from(t)),
                t instanceof b == 0 &&
              ...
              if (t instanceof b) {
                if ((r = t.length) < 256)
                  if (((u[(a += 1)] = 196), (u[(a += 1)] = r), r > 32))
                    t.copy(u, (a += 1), 0, r), (a += r - 1);
                  else for (let e = 0; e < r; e++) u[(a += 1)] = t[e];
                else if (r < 65536)
                  (u[(a += 1)] = 197),
                    (u[(a += 1)] = r >> 8),
                    (u[(a += 1)] = r),
              ...
              }
              {
                ...
                else for (let n = 0; n < r; n += 1) s(e[n]), s(t[e[n]]);
              }
              break;
            default:
              switch (t) {
        ...
        const l = () => {
          ...
          switch (h[c]) {
            ...
            case 207:
              return (
                (t =
                  h.readUInt32BE((c += 1)) * Math.pow(2, 32) +
                  h.readUInt32BE((c += 4))),
                (c += 4),
                t
              );
            ...
            case 211:
              return (
                (t =
                  h.readInt32BE((c += 1)) * Math.pow(2, 32) +
                  h.readUInt32BE((c += 4))),
                (c += 4),
                t
              );
            ...
            case 222:
              if (
                ((r = h.readUInt16BE((c += 1))), (t = {}), (c += 2), !0 === o)
              )
                for (let e, n = 0; n < r; n++) (e = l()), (t[i[e] || e] = l());
              else for (let e = 0; e < r; e++) t[l()] = l();
              return t;
            case 223:
              if (
                ((r = h.readUInt32BE((c += 1))), (t = {}), (c += 4), !0 === o)
              )
                for (let e, n = 0; n < r; n++) (e = l()), (t[i[e] || e] = l());
              else for (let e = 0; e < r; e++) t[l()] = l();
              return t;
...
Player.attributes.add("playerId", { type: "string", default: -1 }),
  ...
  Player.attributes.add("meleeCenter", { type: "entity" }),
  Player.attributes.add("hammerEntity", { type: "entity" }),
  Player.attributes.add("katanaEntity", { type: "entity" }),
  Player.attributes.add("sex", { type: "string", default: "Female" }),
  Player.attributes.add("lowExposure", { type: "number", default: 4 }),
  Player.attributes.add("throwCooldown", { type: "number", default: 8 }),
  Player.attributes.add("dashCooldown", { type: "number", default: 10 }),
  ...
  (Player.prototype._onCards = function () {
    this.entity.rigidbody.teleport(0, -50, 0, 0, 0, 0),
      ...
      this.characterCameraHolder
        ...
        .to({ x: 0.5, y: 0.5, z: 0.5 }, 1.5, pc.SineOut)
        .start(),
      this.characterCameraHolder
        .tween(this.characterCameraHolder.getLocalEulerAngles())
        .rotate({ x: -165, y: 0, z: 180 }, 2, pc.SineOut)
        .start(),
      setTimeout(
        function (t) {
  ...
  (Player.prototype.onKill = function (t, e) {
    this.emoteReminder ||
      ...
      (this.app.fire(
        "Overlay:Reminder",
        "Press [" + keyboardMap[pc.KEY_H] + "] to emote!"
      ),
  ...
  (Player.prototype.onCameraReturn = function (t) {
    ...
    this.characterCamera
      .tween(this.characterCamera.getLocalPosition())
      .to({ x: 0, y: 1.19, z: 0 }, 0.4, pc.SineOut)
      .start(),
      this.characterCamera
        .tween(this.characterCamera.getLocalEulerAngles())
        .rotate({ x: 0, y: 0, z: 0 }, 0.4, pc.BackOut)
        .start(),
    ...
    for (var a in e) {
      ...
      (i = this.entity.getPosition().clone().sub(o).length()),
        ("TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode) ||
          ...
          t.push({ score: i, point: o, angle: r }),
        "TDM" != pc.currentMode &&
          "PAYLOAD" != pc.currentMode &&
          t.push({ score: i, point: o, angle: r });
    }
    ...
    if (
      ...
      clearTimeout(this.skinMaterialTimer),
        (this.skinMaterialTimer = setTimeout(
          function (t) {
            var i = pc.app
              .tween(t.skinMaterial)
              .to({ emissiveIntensity: 0 }, 0.15, pc.Linear);
  ...
  (Enemy.prototype.melee = function () {
    ...
    this.entity.sound.play(i),
      ...
      this.meleeEntity
        ...
        .rotate({ x: 130.23, y: -78.41, z: -149.33 }, 0.3, pc.BackOut)
        .start();
...
PhysicsManager.attributes.add("mapHolder", { type: "entity" }),
  PhysicsManager.attributes.add("playerEntity", { type: "entity" }),
...
Menu.attributes.add("cameraEntity", { type: "entity" }),
  ...
  (Menu.prototype.triggerChangeUsername = function () {
    ...
    null !== e && this.app.fire("Fetcher:MobileUsername", { username: e });
  }),
  ...
  (Menu.prototype.setKeyboardTable = function (e) {
    ...
    this.app.fire("Table:Keys", { result: t });
  }),
  ...
  (Menu.prototype.onProfileData = function (e) {
    ...
    if (
      ...
      t.length > 1
        ? (this.miniProfileEntity.element.width = 415 + 3.5 * t[1].length)
        : (this.miniProfileEntity.element.width = 415 + 3.5 * t[0].length);
    }
  }),
  ...
  (Label.prototype.setHealth = function (t) {
    ...
    (e = Math.max(e, 0)),
      ...
      this.whiteBarEntity
        ...
        .to({ x: e, y: 1, z: 1 }, 0.8, pc.Linear)
        .start(),
      this.whiteBarEntity
        .tween(this.whiteBarEntity.element)
        .to({ opacity: 0 }, 0.8, pc.BackInOut)
        .start();
  }),
...
Result.attributes.add("topLine", { type: "entity" }),
  ...
  (Result.prototype.clearVoteEntities = function () {
    ...
    (this.mapEntities = []),
      ...
      this.cloudNoiseEntity
        ...
        .rotate({ x: 0, y: 0, z: -170 }, this.maxTime, pc.Linear)
        .start(),
      this.barEntity
        .tween(this.barEntity.element)
        .to({ width: 1400 }, this.maxTime, pc.Linear)
        .start();
  }),
  ...
  (Result.prototype.createPlayerRow = function (t, e) {
    ...
    a &&
      a.script &&
      a.script.button &&
      (a.script.button.fireFunction =
        "Follow:User@" + Utils.cleanUsername(t.username)),
  ...
  (Result.prototype.showMessage = function (t) {
    (this.resultMessage.element.text = t),
      ...
      this.resultMessage
        ...
        .to({ opacity: 1, spacing: 1.3 }, 1.5, pc.BackOut)
        .start(),
      ...
      this.topLine
        ...
        .to({ x: 1, y: 1, z: 1 }, 0.5, pc.ExponentialInOut)
        .start(),
      ...
      setTimeout(
        function (t) {
          t.resultMessage
            .tween(t.resultMessage.getLocalScale())
            .to({ x: 2, y: 2, z: 2 }, 0.8, pc.QuadraticOut)
            .start(),
            t.resultMessage
              .tween(t.resultMessage.element)
              .to({ opacity: 0, spacing: 1 }, 0.8, pc.BackOut)
              .start(),
            t.topLine
            ...
            t.topLine
              ...
              .to({ x: 0.1, y: 0.5, z: 1 }, 0.5, pc.BackOut)
              .start(),
            t.bottomLine
...
Input.attributes.add("placeholder", { type: "string" }),
  ...
  (Input.prototype.onDestroy = function () {
    (this.isDestroyed = !0), this.element && this.element.remove();
  }),
  ...
  (Input.prototype.setValue = function (t) {
    if (this.key && t && t[this.key])
      return (this.element.value = t[this.key]), !1;
    this.element
...
Chat.attributes.add("inputEntity", { type: "entity" }),
  ...
  (Chat.prototype.onMapLoaded = function () {
    ...
    this.app.fire(
      "Chat:Message",
      "Console",
      "Press TAB to see other players scores!"
    ),
      (this.displayed = !0);
  }),
...
Button.attributes.add("connected", { type: "entity" }),
  ...
  (Button.prototype.initialize = function () {
    (this.spinner = !1),
      ...
      this.app.on(
        "Button:" + this.entity.name + ":Resolve",
        this.resolve,
        this
      );
  }),
...
SpellManager.attributes.add("playerEntity", { type: "entity" }),
  ...
  (SpellManager.prototype.applyMidnightCurse = function () {
    this.entity.sound.play("Wolf-Howl"),
      ...
      this.app
        .tween(this.app.scene)
        .to({ fogDensity: 0.3, skyboxIntensity: 0.3 }, 0.3, pc.Linear)
        .start(),
  ...
  (SpellManager.prototype.cancelMidnightCurse = function () {
    ...
    e.app
      .tween(e.app.scene)
      .to(
        { fogDensity: 1e-4, skyboxIntensity: e.defaultSkyboxIntensity },
        0.3,
        pc.Linear
      )
      .delay(0.2)
  ...
  (SpellManager.prototype.applyMuscleShock = function () {
    ...
    (this.currentSpell = "MuscleShock"),
      ...
      this.app
        ...
        .to({ bounceAngle: 3 }, 0.03, pc.Linear)
        .yoyo(!0)
        .repeat(7)
        .start(),
      this.app.fire("Player:StopSpeaking", !0),
  ...
  (SpellManager.prototype.applyVenom = function () {
    ...
    (this.venomEntity.enabled = !0),
      ...
      (this.venomTween = this.app
        .tween(this.venomEntity.sprite)
        .to({ opacity: 0.45 }, 2, pc.BackIn)),
  ...
  (SpellManager.prototype.applyFrostBomb = function () {
    ...
    this.cameraEntity.camera.fov > 75 && (t = 2.5),
      ...
      (this.iceTween = this.app
        .tween(this.iceMaterial)
        .to({ opacity: 1 }, 1, pc.Linear)),
...
Tab.attributes.add("menu", { type: "string", array: !0 }),
  ...
  Tab.attributes.add("align", {
    type: "string",
    enum: [{ Vertical: "Vertical" }, { Horizontal: "Horizontal" }],
    default: "Vertical",
  }),
...
Form.attributes.add("inputs", { type: "entity", array: !0 }),
  ...
  (Form.prototype.onFormSet = function (t) {
    for (var i in this.keys) {
      ...
      e.input
        ? this.inputs[i].script.input.setValue(t[s])
        : e.checkbox
        ? this.inputs[i].script.checkbox.setValue(t[s])
        : e.hidden && this.inputs[i].script.hidden.setValue(t[s]);
    }
  }),
  (Form.prototype.onFormSubmit = function () {
    ...
    for (var i in this.keys) {
      var s = this.keys[i],
        e = this.inputs[i].script;
      e.input
        ? (t[s] = this.inputs[i].script.input.getValue())
        : e.checkbox
        ? (t[s] = this.inputs[i].script.checkbox.getValue())
        : e.hidden && (t[s] = this.inputs[i].script.hidden.getValue());
    }
...
Table.attributes.add("labels", { type: "string", array: !0 }),
  ...
  (Table.prototype._onInit = function () {
    ...
    (t += "table { border-collapse: collapse; }"),
      ...
      (t +=
        ".two-buttons td:last-child, .two-buttons th:last-child { width: 10vw; }"),
  ...
  (Table.prototype.formatMarkup = function (t) {
    return t && t.replace
      ? t
      ...
      for (var r in this.keys) {
        ...
        if (s.search("\\$verified") > -1) {
          ...
          "1" == n.verified &&
            ...
            (o.innerHTML = l + " " + this.formatMarkup(n[h]));
        } else
          "$thumbnail" == s
            ...
            : (o.innerHTML = this.formatMarkup(n[s]));
        a.appendChild(o);
      }
...
Bar.attributes.add("key", { type: "string" }),
  ...
  Bar.attributes.add("particleType", {
    type: "string",
    enum: [{ onEnd: "onEnd" }, { onDuring: "onDuring" }],
    default: "onEnd",
  }),
      ...
      a > 0
        ? this.isAnimated
          ? this.entity
              ...
              .to({ x: a }, this.animationDuration, pc.SineOut)
              .start()
...
RoomManager.attributes.add("isDebug", { type: "boolean", default: !0 }),
  ...
  (RoomManager.prototype.setSession = function () {
    pc.session && pc.session.hash
      ? ((this.hash = pc.session.hash),
        pc.session.username &&
          (this.username = Utils.cleanUsername(pc.session.username)))
      : (this.hash = !1);
  }),
...
Container.attributes.add("id", { type: "string" }),
  ...
  Container.attributes.add("showOnly", {
    type: "string",
    enum: [{ Both: "Both" }, { Desktop: "Desktop" }, { Mobile: "Mobile" }],
    default: "Both",
  }),
...
(Analytics.prototype.initialize = function () {
  ...
  (Analytics.prototype.setEvent = function (t, e) {
    "undefined" != typeof gtag &&
      gtag("event", e, { event_category: t, event_label: e });
  });
...
Checkbox.attributes.add("default", { type: "boolean" }),
  ...
  (Checkbox.prototype.setValue = function (e) {
    if (this.element && this.key && e)
      return (this.element.checked = e[this.key]), !1;
    this.element
...
MobileController.attributes.add("joystickEntity", { type: "entity" }),
  ...
  MobileController.attributes.add("buyButton", { type: "entity" }),
...
AdsManager.attributes.add("defaultProvider", {
  type: "string",
  enum: [{ Adinplay: "Adinplay" }, { VLI: "VLI" }, { Poki: "Poki" }],
  default: "Adinplay",
}),
...
Spectator.attributes.add("defaultSensitivity", {
  ...
  (Spectator.prototype.focusTarget = function () {
    this.getTargets(),
      ...
      (this.zoomOutTween = this.app
        .tween(this.entity.camera)
        .to({ fov: 70 }, 0.2, pc.Linear)),
...
Preview.attributes.add("baseEntity", { type: "entity" }),
  ...
  (Preview.prototype.onEquip = function () {
    this.entity.sound.play("Equip"),
      ...
      this.baseEntity
        ...
        .to({ x: 1, y: 1, z: 1 }, 0.15, pc.BackOut)
        .start();
  }),
  (Preview.prototype.onOpen = function (t) {
    (this.itemPreview.enabled = !1),
      ...
      this.baseEntity
        .tween(this.baseEntity.getLocalScale())
        .to({ x: 1.2, y: 1.2, z: 1.2 }, 0.7, pc.Linear)
        .start();
  ...
  (Preview.prototype.openCrate = function () {
    (this.lookAngle = 0),
      ...
      this.crateEntity
        ...
        .rotate({ x: 20, y: 0, z: 0 }, 0.3, pc.BackOut)
        .delay(0.2)
        .start(),
      this.lidEntity &&
        ((this.animation.lidAxis = 0),
...
Shop.attributes.add("shopType", { type: "string" }),
  ...
  (Shop.prototype.onTransaction = function (t) {
    ...
    e.setLocalPosition(0, 0, 0),
      ...
      e
        .tween(e.getLocalPosition())
        .to({ x: 0, y: 50, z: 0 }, 0.4, pc.BackOut)
        .start(),
      e.tween(e.element).to({ opacity: 0 }, 0.4, pc.Linear).start();
  }),
  ...
  (Shop.prototype.onItemUnlock = function () {
    ...
    "Offers" == this.shopType
      ? this.app.fire("Fetcher:OfferBuy", { offer_id: t.item_id })
      : (this.app.fire("Fetcher:OfferBuy", { offer_id: t.item_id }),
        (this.buyTimeout = !0),
        setTimeout(
          function (t) {
...
Outline.attributes.add("color", { type: "rgba" }),
  ...
  Outline.attributes.add("currentEntity", { type: "entity" }),
  Outline.attributes.add("outlineCamera", { type: "entity" }),
...
Digit.attributes.add("backgroundEntity", { type: "entity" }),
  ...
  (Digit.prototype.onDigitChange = function (t) {
    ...
    var i = this,
      o = this.entity
        .tween(this.entity.getLocalScale())
        .to({ x: 4, y: 4, z: 4 }, 0.3, pc.BackInOut);
    if (
    ...
    return (
      "Attention" == this.animation &&
        ...
        t.push(
          this.entity
            .tween(this.entity.getLocalScale())
            .to({ x: 1.3, y: 1.3, z: 1.3 }, 0.6, pc.QuinticInOut)
            .yoyo(!0)
            .repeat(2)
        ),
        t.push(
      ...
      "Beat" == this.animation &&
        ...
        t.push(
          this.entity
            .tween(this.entity)
            .to({ timer: 1 }, 0.35, pc.Linear)
            .delay(2)
        ),
        t.push(
          this.entity
            .tween(this.entity.getLocalScale())
            .to({ x: 1.5, y: 1.5, z: 1.5 }, 0.35, pc.Linear)
        ),
        t.push(
          this.entity
            .tween(this.entity.element)
      ...
      "Pulse" == this.animation &&
        ...
        t.push(
          this.entity
            .tween(this.entity.getLocalScale())
            .to({ x: 1.3, y: 1.15, z: 1.3 }, 0.175, pc.Linear)
            .delay(0.4)
            .yoyo(!0)
            .repeat(4)
        )),
      ...
      "PickMe" == this.animation &&
        ...
        t.push(
          this.entity
            .tween(this.entity.getLocalScale())
            .to({ x: 1.2, y: 1.2, z: 1.2 }, 0.3, pc.BackOut)
            .yoyo(!0)
            .repeat(2)
        ),
        t.push(
      ...
      "LowRise" == this.animation &&
        ...
        t.push(
          this.entity
            .tween(this.entity.getLocalScale())
            .to({ x: 2, y: 2, z: 2 }, 0.8, pc.QuadraticInOut)
            .yoyo(!0)
            .repeat(2)
        ),
        t.push(
  ...
  (CustomList.prototype.setCustomList = function (t) {
    ...
    for (var s in i) {
      ...
      for (var r in a) {
        var n = a[r];
        "Color" == n.name
          ? (o.findByName(n.name).element.color = Utils.hex2RGB(
              e[this.fields[r]]
            ))
          : (o.findByName(n.name).element.text = e[this.fields[r]]);
      }
...
CustomChat.attributes.add("isDebug", { type: "boolean", default: !0 }),
  ...
  (CustomChat.prototype.parse = function (t) {
    if (0 === t.length) return !1;
    var s = t[0];
    Object.keys(this.keys).indexOf(s) > -1 &&
      this[this.keys[s]](t.splice(1, t.length + 1));
  }),
